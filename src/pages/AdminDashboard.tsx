...
const PAGE_DEFINITIONS: { page: string; label: string; sections: { section: string; label: string; type: string }[] }[] = [
  ...
  {
    page: 'crisis_steps', label: 'De-escalation Steps (Crisis)', sections: [
      { section: 'step_1_title', label: 'Step 1: Title', type: 'text' },
      { section: 'step_1_instruction', label: 'Step 1: Instruction', type: 'textarea' },
      { section: 'step_1_tip', label: 'Step 1: Tip', type: 'textarea' },
      { section: 'step_2_title', label: 'Step 2: Title', type: 'text' },
      { section: 'step_2_instruction', label: 'Step 2: Instruction', type: 'textarea' },
      { section: 'step_2_tip', label: 'Step 2: Tip', type: 'textarea' },
      { section: 'step_3_title', label: 'Step 3: Title', type: 'text' },
      { section: 'step_3_instruction', label: 'Step 3: Instruction', type: 'textarea' },
      { section: 'step_3_tip', label: 'Step 3: Tip', type: 'textarea' },
      { section: 'step_4_title', label: 'Step 4: Title', type: 'text' },
      { section: 'step_4_instruction', label: 'Step 4: Instruction', type: 'textarea' },
      { section: 'step_4_tip', label: 'Step 4: Tip', type: 'textarea' },
      { section: 'step_5_title', label: 'Step 5: Title', type: 'text' },
      { section: 'step_5_instruction', label: 'Step 5: Instruction', type: 'textarea' },
      { section: 'step_5_tip', label: 'Step 5: Tip', type: 'textarea' },
      { section: 'step_6_title', label: 'Step 6: Title', type: 'text' },
      { section: 'step_6_instruction', label: 'Step 6: Instruction', type: 'textarea' },
      { section: 'step_6_tip', label: 'Step 6: Tip', type: 'textarea' },
      { section: 'step_7_title', label: 'Step 7: Title', type: 'text' },
      { section: 'step_7_instruction', label: 'Step 7: Instruction', type: 'textarea' },
      { section: 'step_7_tip', label: 'Step 7: Tip', type: 'textarea' },
    ]
  },
  {
    page: 'try_again_steps', label: 'Try Again Tool Steps', sections: [
      { section: 'step_1_title', label: 'Step 1: Title', type: 'text' },
      { section: 'step_1_instruction', label: 'Step 1: Instruction', type: 'textarea' },
      { section: 'step_1_prompt', label: 'Step 1: Prompt', type: 'text' },
      { section: 'step_1_affirmation', label: 'Step 1: Affirmation', type: 'text' },
      { section: 'step_2_title', label: 'Step 2: Title', type: 'text' },
      { section: 'step_2_instruction', label: 'Step 2: Instruction', type: 'textarea' },
      { section: 'step_2_prompt', label: 'Step 2: Prompt', type: 'text' },
      { section: 'step_2_affirmation', label: 'Step 2: Affirmation', type: 'text' },
      { section: 'step_3_title', label: 'Step 3: Title', type: 'text' },
      { section: 'step_3_instruction', label: 'Step 3: Instruction', type: 'textarea' },
      { section: 'step_3_prompt', label: 'Step 3: Prompt', type: 'text' },
      { section: 'step_3_affirmation', label: 'Step 3: Affirmation', type: 'text' },
      { section: 'step_4_title', label: 'Step 4: Title', type: 'text' },
      { section: 'step_4_instruction', label: 'Step 4: Instruction', type: 'textarea' },
      { section: 'step_4_prompt', label: 'Step 4: Prompt', type: 'text' },
      { section: 'step_4_affirmation', label: 'Step 4: Affirmation', type: 'text' },
      { section: 'step_5_title', label: 'Step 5: Title', type: 'text' },
      { section: 'step_5_instruction', label: 'Step 5: Instruction', type: 'textarea' },
      { section: 'step_5_prompt', label: 'Step 5: Prompt', type: 'text' },
      { section: 'step_5_affirmation', label: 'Step 5: Affirmation', type: 'text' },
      { section: 'step_6_title', label: 'Step 6: Title', type: 'text' },
      { section: 'step_6_instruction', label: 'Step 6: Instruction', type: 'textarea' },
      { section: 'step_6_prompt', label: 'Step 6: Prompt', type: 'text' },
      { section: 'step_6_affirmation', label: 'Step 6: Affirmation', type: 'text' },
      { section: 'step_7_title', label: 'Step 7: Title', type: 'text' },
      { section: 'step_7_instruction', label: 'Step 7: Instruction', type: 'textarea' },
      { section: 'step_7_prompt', label: 'Step 7: Prompt', type: 'text' },
      { section: 'step_7_affirmation', label: 'Step 7: Affirmation', type: 'text' },
    ]
  },
]
